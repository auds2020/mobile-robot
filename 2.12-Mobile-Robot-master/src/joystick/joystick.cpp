...
//TODO set address to robot mac adress 0C:DC:7E:CC:6B:D8
uint8_t broadcastAddress[] = {0x0C, 0xDC, 0x7E, 0xCC, 0x6B, 0xD8};
...
void loop(){
    ...
    flagstaff = false;
    if (joyData.rightPressed != 0 && flagstaff == true){
    //Serial.println("In manual!");
    flagstaff = true;
    } else {
      //Serial.println("In autonomous baby");
    }
